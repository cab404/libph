...
public class LSJSON {
    ...
    public static Blog parseBlog(JSONObject object) {
        ...
        if (object.containsKey("creation_date"))
            blog.creation_date = LS.parseSQLDate((String) object.get("creation_date"));
    ...
    public static Topic parseTopic(JSONObject object) {
        ...
        if (object.containsKey("date")) topic.date = LS.parseSQLDate((String) object.get("date"));
    ...
    public static Comment parseComment(JSONObject object) {
        ...
        if (object.containsKey("date")) comment.date = LS.parseSQLDate((String) object.get("date"));
    ...
    public static Letter parseLetter(JSONObject object) {
        ...
        if (object.containsKey("date")) letter.date = LS.parseSQLDate((String) object.get("date"));
